        ...
        <div className="p-6 space-y-6 max-h-[80vh] overflow-y-auto">
          ...
          <div className="space-y-2">
            <div className="flex justify-between items-center">
              ...
              <span className="text-[11px] text-slate-500 font-mono">
                Format: Name, Email, Role, State, Region, Head of Unit, Head of Sales
              </span>
            </div>
            ...
            <textarea
              ...
              placeholder={`Name, Email, Role, State, Region, Head of Unit, Head of Sales\nAhmad Razak, ahmad.razak@example.com, Sales Team, Selangor, Central, Dr. Kamil Ariffin, Dato' Wong Wei Sheng\nSiti Sarah, siti.sarah@example.com, Head of Sales, Penang, Northern, Dr. Kamil Ariffin, Siti Sarah\nWong Wei Ming, wong.wm@example.com, Device Team, Kuala Lumpur, Central, Dr. Kamil Ariffin, Dato' Wong Wei Sheng`}
          ...
          {parsedUsers.length > 0 && (
            <div className="space-y-3">
              ...
              <div className="border border-slate-200 rounded-xl overflow-x-auto max-h-56 overflow-y-auto bg-white">
                <table className="w-full text-left text-xs min-w-[1000px] whitespace-nowrap">
                  <thead className="bg-slate-100 text-slate-700 font-semibold border-b border-slate-200 sticky top-0">
                    <tr>
                      ...
                      <th className="px-3.5 py-2.5">Head of Unit</th>
                      ...
                      return (
                        <tr key={u.id} className="hover:bg-slate-50">
                          ...
                          <td className="px-3.5 py-2">
                            <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-[10px] font-semibold border ${getRoleBadge(u.role)}`}>
                              {u.role}
                            </span>
                          </td>
                          <td className="px-3.5 py-2 text-slate-600">{u.state}</td>
                          <td className="px-3.5 py-2 font-medium text-slate-700">{u.region}</td>
                          <td className="px-3.5 py-2 font-medium text-cyan-800">{u.headOfUnit || '-'}</td>
                          ...
                          <td className="px-3.5 py-2 font-mono text-xs text-slate-600">
                            {u.password || '••••••••'}
                          </td>
                        </tr>
                      );
