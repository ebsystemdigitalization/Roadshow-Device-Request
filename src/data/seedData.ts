...
export const INITIAL_USERS: User[] = [
  ...
  {
    id: 'usr-hou-1',
    name: 'Dr. Kamil Ariffin',
    email: 'kamil.ariffin@company.com',
    role: 'Head of Unit',
    state: 'Kuala Lumpur',
    region: 'Central',
    headOfUnit: 'Dr. Kamil Ariffin',
